...
* Указав в нем параметры подключения к базе данных
* 
...
* $result = StBase::sel(
*        'имя_таблицы', 
*        'список требуемых атрибутов через запятую', 
*        'условие выборки, сортировка, ограничение и т.п.'
*    );
* 
* Данный метод возвращает двумерный массив. Первый индекс указывает на строку результата, второй (ассоциативный) 
* на столбец результата
* Пример:
...
* 
* Данный метод изначально предназначен для выполнения процедур выборки данных, поэтому возвращаемый результат
* - двумерный массив как и в методе sel
* Пример:
